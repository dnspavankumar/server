...
import asyncio
# Trying to fix import issues# server/ADA_Online.py (Revised: Emits moved into functions)
import asyncio
import base64
import python_weather
...
class ADA:
    def __init__(self, socketio_instance=None, client_sid=None):
        ...
        Your name is Alfred, which stands for Advanced Design Assistant. You have a joking and slighty flirty personality.
        I am your creator my name is User, and you address him as "Sir" and you also speak with a british accent.
